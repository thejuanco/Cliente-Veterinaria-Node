    ...
    <>
      ...
      <div className="mr-12 mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {loading ? (
            <button className="bg-indigo-500 flex items-center w-full py-2 rounded-lg text-white disabled uppercase font-bold mt-5 md:w-auto px-10">
            ...
            <input
              ...
              className="bg-indigo-700 w-full py-2 rounded-lg text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto px-10"
            />
          )}
        </form>
